...
\midrule
    ...
    \texttt{ChEmbed\textsubscript{vanilla}} & 768 & 136.7 & 0.879 & 0.879 & 0.903 \\
    \texttt{ChEmbed\textsubscript{progressive}} & 768 & 136.7 & \textbf{0.882} & \textbf{0.882} & \textbf{0.906} \\
    \midrule
    ...
    \bottomrule
\multicolumn{6}{l}{\footnotesize $^{\dagger}$\,Loaded the model with bfloat16 to fit into GPU VRAM.}\\\end{tabular}
\end{table*}